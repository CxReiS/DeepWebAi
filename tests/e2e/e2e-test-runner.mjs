...
const showMenu = () => {
  ...
  console.log('7) Run All Tests (Continue on Failure)');
  console.log('8) Run with Browser UI (Headed Mode)');
  console.log('9) Debug Mode');
  console.log('10) Generate Test Report');
  console.log('11) Test Environment Setup');
  console.log('12) Exit');
  ...
  if (args.length > 0) {
    ...
    switch (command) {
      ...
      default:
        ...
        console.log('Available commands: setup, auth, features, files, ai, realtime, all, all-continue, headed, debug, report');
        break;
    }
    return;
  }
