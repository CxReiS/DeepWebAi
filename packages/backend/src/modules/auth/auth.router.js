...
exports.authRouter = exports.adminAuthRouter = exports.oauthRouter = exports.userProfileRouter = void 0;
const elysia_1 = require("elysia");
const auth_controller_js_1 = require("./auth.controller.js");
const index_js_1 = require("../../src/auth/index.js");
const index_js_2 = require("../../src/auth/index.js");
// User profile management routes
exports.userProfileRouter = new elysia_1.Elysia({ prefix: '/user', name: 'user-profile' })
    .use(index_js_1.authMiddleware)
    ...
    try {
        const fullUser = await index_js_2.AuthService.getUserById(user.id);
        if (!fullUser) {
            set.status = 404;
            return {
                success: false,
    ...
    try {
        const updatedUser = await index_js_2.AuthService.updateProfile(user.id, body);
        return {
            success: true,
    ...
    try {
        ...
        await index_js_2.AuthService.logout(sessionCookie || '');
...
// OAuth routes
exports.oauthRouter = new elysia_1.Elysia({ prefix: '/oauth', name: 'oauth' })
...
exports.adminAuthRouter = new elysia_1.Elysia({ prefix: '/admin', name: 'admin-auth' })
    .use(index_js_1.requireAuth)
    .derive(({ user, set }) => {
    ...
    try {
        const { UserQueries } = await import("../../database/operations/user.queries.js");
        const { limit = 20, offset = 0, role, search } = query;
    ...
    try {
        const user = await index_js_2.AuthService.getUserById(params.id);
        if (!user) {
            set.status = 404;
            return {
                success: false,
    ...
    try {
        ...
        const updatedUser = await index_js_2.AuthService.updateProfile(params.id, { role });
        return {
            success: true,
...
exports.authRouter = new elysia_1.Elysia({ prefix: '/api', name: 'auth-router' })
    .use(auth_controller_js_1.authController)
    .use(exports.userProfileRouter)
    .use(exports.oauthRouter)
    .use(exports.adminAuthRouter);
